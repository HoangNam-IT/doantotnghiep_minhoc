...
if(!isset($_GET['temp'])){
	...
	printf(
		__( 'Xin chào %1$s (nếu không phải %1$s? <a href="%2$s">Đăng xuất</a>)', 'woocommerce' ),
	...
	<p><?php
	printf(
		__( 'Từ tài khoản của bạn, bạn có thể xem các <a href="%1$s">recent orders</a>, quản lý <a href="%2$s">địa chỉ giao hàng</a>, và <a href="%3$s">thay đổi mật khẩu</a>.', 'woocommerce' ),
